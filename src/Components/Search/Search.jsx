...
const Search = () => {
  ...
  return (
    <div className="mt-28">
      <form className="lg:flex   flex-wrap lg:bottom-12 mt justify-center max-w-5xl mx-auto bg-white shadow-lg gap-4 p-6 transition-all duration-300 border border-gray-200 rounded-md">
        <div className="mb-4">
          <label
